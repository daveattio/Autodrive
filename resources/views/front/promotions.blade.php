            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full group">
                ...
                <div class="p-5 flex flex-col flex-grow">
                    ...
                    <div class="mt-auto pt-4 border-t border-gray-100">
                        ...
                        @if($promo->vehicle_id)
                        <!-- CAS 1 : Promo liée à un véhicule -> On va vers les détails -->
                        <a href="{{ route('vehicle.show', $promo->vehicle_id) }}" class="block text-center w-full bg-blue-600 text-white px-4 py-3 rounded-xl font-bold text-sm hover:bg-blue-700 transition shadow-md flex items-center justify-center gap-2">
                        ...
                        @else
                        <!-- CAS 2 : Promo générale -> On va vers le catalogue -->
                        <a href="{{ route('vehicles.index') }}" class="block text-center w-full bg-gray-900 text-white px-4 py-3 rounded-xl font-bold text-sm hover:bg-gray-800 transition shadow-md">
                            Voir le catalogue
                        </a>
                        @endif
                    </div>
