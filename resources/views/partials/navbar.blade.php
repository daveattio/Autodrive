...
@auth
    @php
        ...
        elseif ($user->role === 'admin') {
            ...
            $label = 'Admin';
            // Icône Cadenas
            $iconHtml = '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>';
        }
        else {
            ...
            switch ($user->client_type) {
                ...
                default: // Particulier
                    ...
                    $label = 'Particulier';
                    // Icône Utilisateur
                    $iconHtml = '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>';
                    break;
            }
        }
    @endphp

    <!-- AFFICHAGE DU BADGE DYNAMIQUE -->
    <div class="flex items-center {{ $badgeClass }} rounded-full p-1 pr-4 transition hover:shadow-md cursor-default select-none">

        <!-- Icône (Cercle blanc avec couleur) -->
        <div class="bg-white p-2 rounded-full shadow-sm {{ $iconColor }} mr-3">
            {!! $iconHtml !!}
        </div>
